...
public class ActionAdapter extends RecyclerView.Adapter<ActionAdapter.myViewHodler> {
    ...
    public myViewHodler onCreateViewHolder(ViewGroup parent, int viewType) {
        //创建自定义布局
        View itemView = View.inflate(context, R.layout.player_item, null);
...
//        holder.mItemGoodsImg;
    ...
    class myViewHodler extends RecyclerView.ViewHolder {
        ...
        public myViewHodler(View itemView) {
            super(itemView);
            mItemGoodsImg = (ImageView) itemView.findViewById(R.id.item_imgv);
            mItemGoodsName = (TextView) itemView.findViewById(R.id.item_tv);
            mItemGoodsPrice = (TextView) itemView.findViewById(R.id.item_price);
